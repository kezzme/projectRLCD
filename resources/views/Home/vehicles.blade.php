...
<!-- Page Header Start -->
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-5.jpg);">
  <div class="container-fluid page-header-inner py-5">
    <div class="container text-center">
      <h1 class="display-3 text-white mb-3 animated slideInDown">Here Are The List Of Our Available Units</h1>
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
  <div class="owl-carousel testimonial-carousel position-relative"> 
    ...
    <div class="testimonial-item text-center">
      ...
      <div>
        @auth
          <a class="btn btn-primary col-md-4 animated slideInDown" href="/vehicles/trade_in/{{$unit->uid}}">Trade-in</a>
          <a class="btn btn-primary col-md-4 animated slideInDown" href="/vehicles/view_details/{{$unit->uid}}">View Details</a>
        @else
