...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
  <div class="owl-carousel testimonial-carousel position-relative"> 
    ...
    <div class="testimonial-item text-center">
      ...
      <div>
        @auth
          <a class="btn btn-primary col-md-4 animated slideInDown" href="/new-arrival/trade_in/{{$unit->uid}}">Trade-in</a>
          <a class="btn btn-primary col-md-4 animated slideInDown" href="/new-arrival/view_details/{{$unit->uid}}">View Details</a>
        @else
