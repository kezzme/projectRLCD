<x-system-layout>
  ...
  @endif
    ...
    <main id="main" class="main">
            ...
            <h1>Acknowledgment Receipt</h1>
              <nav>
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Trade-in Form</li>
                  </ol>
                </nav>
          </div>
          </div> 
      ...
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-4 input-group-text justify-content-center">Agreed Amount *</label>
          <input type="text" name="agreed_amount" id="agreed_amount" class="form-control total_price" maxlength="7" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class="input-group">
    ...
    <div class="col-md-6">
      <div class=" input-group">
        <label class="col-md-3 input-group-text justify-content-center">Trade Value *</label>
    ...
    @endforeach
      ...
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-3 input-group-text justify-content-center">Year *</label>
          <input type="text" name="unit_year" id="unit_year" class="form-control" maxlength="4" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-3 input-group-text justify-content-center">Make *</label>
          <input type="text" name="unit_make" id="unit_make" class="form-control" style="text-transform: capitalize" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-3 input-group-text justify-content-center">Model *</label>
          <input type="text" name="unit_model" id="unit_model" class="form-control" style="text-transform: capitalize" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-3 input-group-text justify-content-center">Variant *</label>
          <input type="text" name="unit_variant" id="unit_variant" class="form-control" style="text-transform: uppercase" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-3 input-group-text justify-content-center">Trade Value *</label>
          <input type="text" name="unit_price" id="unit_price" class="form-control total_price" maxlength="7" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class=" input-group">
          <label class="col-md-3 input-group-text justify-content-center">Plate No. *</label>
          <input type="text" name="unit_plate_no" id="unit_plate_no" class="form-control" style="text-transform: uppercase" required>
        </div>  
      </div>
      <div class="col-md-12">
        <div>
      ...
      <div class="col-md-4 d-grid gap-2 d-md-flex justify-content-md-end">
        ...
        <div class="dropup-center dropup">
          ...
          <ul class="dropdown-menu">
            <li>
              <button class="dropdown-item" type="button" onclick="showConfirmationModal('TRADED')">TRADED</button>
            </li>
            <li>
  ...
  <script>
   ...
   function setAction(action) {
      ...
      if (action === 'TRADED') {
        document.querySelector('form').action = "{{ route('system.receipts.totiTraded') }}";
      } else if (action === 'RESERVED') {
        document.querySelector('form').action = "{{ route('system.receipts.totiReservation') }}";
      }
