      ...
      <div class="col-12">
        <div class="card recent-sales overflow-auto rounded-5">
          <div class="card-body table-responsive">
            <h3 class="card-title text-center" style="font-size: 30px;">FINANCING FORM</h3>
             <form class="row g-3">
              <div class="col-md-3">
  ...
  <div class="col-md-3">
   ...
   <div class="col-md-3">
    <div class="input-group">
      ...
      <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="pending" disabled>    
    </div>
   </div>
