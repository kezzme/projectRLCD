    ...
    <div class="row mt-3 mx-3 ">
      <div class="col-md-3">
        <div style="margin-top: 50px; margin-left: 10px;" class="text-center">
          <i class="fa-solid fa-spray-can-sparkles fa-3x" style="color: #ffffff;"></i>
          <h3 class="mt-3 text-white">Car Wash</h3>
          <p class="white-text">Unveiling a shimmering brilliance that turns heads on every road.</p>
        </div>
      </div>
      <div class="col-md-9 justify-content-center" style="margin-top:30px ;">
        <div class="card card-custom pb-4">
          <div class="card-body mt-0 mx-5">
            ...
            <form action="{{route('system.walk_in.carwash_store')}}" method="POST">
              @csrf
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class=" input-group">
                      ...
                      <input type="text" class="form-control btn-rounded" name="amount" id="outputInput" value="90.00" readonly required>
                  </div>
              </div>
...
<script>
  ...
  <script>
   ...
   function setAction(action) {
      ...
      if (action === 'CONFIRM') {
        document.querySelector('form').action = "{{ route('system.walk_in.carwash_store') }}";
      } 
