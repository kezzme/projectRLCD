    ...
    <div class="container">
      <div class="row gx-5">
        <div class="col-lg-5 py-5">
          <div class="py-5">
            <h1 class="text-white mb-4">Auto Detailing Service</h1>
            <p class="text-white mb-0">
              Discover Excellence in Auto Detailing Services!
              Uncover the True Beauty of Your Vehicle with Our Expert Team. 
              ...
              <ul class="text-white">
                  <li><b class="text-danger">Exterior Detailing</b>: Restore Your Car's Shine and Protect It from the Elements.</li>
                  <li><b class="text-danger">Interior Deep Cleaning</b>: Say Goodbye to Dirt and Dust with Our Thorough Interior Cleaning.</li>
                  <li><b class="text-danger">Paint Enhancement</b>: Revive Your Car's Paint Finish with Our Professional Techniques.</li>
                  <li><b class="text-danger">Leather Upholstery Care</b>: Keep Your Leather Seats Supple and Luxurious.</li>
                  <li><b class="text-danger">Headlight Restoration</b>: Improve Nighttime Visibility with Crystal Clear Headlights.</li>
                  <li><b class="text-danger">Tire and Wheel Detailing</b>: Enhance Your Car's Look with Tire and Wheel Cleaning and Conditioning.</li>
                  <li><b class="text-danger">Engine Bay Cleaning</b>: Keep Your Engine Looking Fresh and Running Smoothly.</li>
                  <li><b class="text-danger">Window and Glass Polishing</b>: Achieve Crystal Clear Windows for Optimal Visibility.</li>
                  <li><b class="text-danger">Odor Removal</b>: Say Goodbye to Unwanted Odors with Our Specialized Treatment.</li>
              </ul>
          </p>
